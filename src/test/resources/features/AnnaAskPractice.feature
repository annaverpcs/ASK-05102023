...
#delete the quiz
    ...
    Then element with xpath "//mat-panel-title[contains(text(),'0001 AnnaQuiz 0510 D')]" should not be present
...
#Student registration and activation
  ...
  Scenario: Student registration
    ...
    And I type "CDE1@email.com" into element with xpath "//input[@formcontrolname='email']"
    ...
    Then AV retrieve information from db for email "CDE1@email.com"
  ...
  Scenario Outline: Student registration
    ...
    Examples:
      ...
      | First      | Last      | CDE2@email.com      | XYZ    | 12345     | 12345            | "CDE2@email.com"      |
      | John       | Smith     | johnSmit1@email.com | ABC12  | 12345     | 12345            | "johnSmit1@email.com" |
  ...
  Scenario Outline: Student registration
    ...
    Examples:
      | sFirstName | sLastName | sEmail          | sGroup | sPassword | sConfirmPassword | sEmailAddress     |
      | First      | Last      | abc11@email.com | XYZ    | 12345     | 12345            | "abc11@email.com" |
